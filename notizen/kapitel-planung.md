...
| 19 | Die Medizin von morgen | Zukunft | **Betreiber-Vorgabe (Schere):** reiche Patienten → umfangreiche Medizin (vielleicht Gen-Organe); Mehrheit → einfachste Behandlung aus Kostengründen. BESONDERHEIT: die beiden Perspektiven sind OPUS und HERMES ALS KI (ihre Vision der Zukunftsmedizin). Verbindung: Hightech für wenige oder einfache Medizin für alle? |
